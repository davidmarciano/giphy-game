...
const { START, startSearch, SET_RESULTS, setSearchResults } = actionsAndTypes;

describe('actions', () => {
    it('should start a search in Giphy api', () => {
        const payload = 'nba';
        const expectedAction = {
            type: START,
            payload
        }
        expect(startSearch(payload)).toEqual(expectedAction)
    })
});

describe('actions', () => {
    it('should set a search results', () => {
        const payload = [
            {
              type: 'gif',
        ...
        expect(setSearchResults(payload)).toEqual(expectedAction)
    })
});